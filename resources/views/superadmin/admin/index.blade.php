...
@section("button")
<a href="{{ route('daftar-admin.create') }}" class="d-none d-sm-inline-block btn btn-sm text-white shadow-sm" style="background-color: #256d85"><i class="fas fa-download fa-sm text-white"></i>Tambah</a>
@endsection 

@section('isi')
<div class="container">
   @if ($datas->isNotEmpty())
   <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">List Admin</h2>
      ...
      <tbody>
         <tr class="align-self-center" style="border: 1px solid black">
            ...
            <td class="text-center justify-content-center align-self-center d-flex">
               <a class="btn border-0 btn-info" href="{{ route('daftar-admin.edit',$key->id)}}">Ubah</a>
