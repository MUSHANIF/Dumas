...
.home{
    ...
    background:url(..assets/imagess/images/home-bg-img.png) no-repeat;
...
<header>
    ...
    <a href="#" class="logo"><span>Du</span>mas</a>
    ...
    <nav class="navbar">
        <a href="#home">home</a>
        <a href="#features">Cara mengadu!</a>
...
<section class="home" id="home">
    ...
    <div class="content">
        <h3>Pengaduan <span>masyarakat</span></h3>
    ...
    <div class="image">
        <img src="{{ asset('assets/imagess/images/home-img.png') }}" alt="">
    </div>
